<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-8">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Manage your available courses and their sessions</p>
        </div>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-700 dark:to-gray-700">
                            ...
                            <th class="px-6 py-4 text-left text-xs font-semibold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider">Course Name</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider">Price</th>
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-indigo-50 dark:hover:bg-gray-700 transition duration-200">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center space-x-3">
                                    <!-- Edit Button -->
                                    <a href="{{ route('courses.edit', $course) }}" class="flex items-center justify-center h-9 w-9 rounded-full bg-blue-100 text-blue-600 hover:bg-blue-200 transition-colors duration-200 dark:bg-blue-900 dark:text-blue-200 dark:hover:bg-blue-800" title="Edit Course">
                                    ...
                                    <!-- Session Button -->
                                    <a href="{{ route('courses.session',$course) }}" class="flex items-center justify-center h-9 w-9 rounded-full bg-indigo-100 text-indigo-600 hover:bg-indigo-200 transition-colors duration-200 dark:bg-indigo-900 dark:text-indigo-200 dark:hover:bg-indigo-800" title="Course Sessions">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    ...
                                    <form action="{{ route('courses.destroy', $course) }}" method="POST" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" onclick="return confirm('Are you sure you want to delete this course?')" class="flex items-center justify-center h-9 w-9 rounded-full bg-red-100 text-red-600 hover:bg-red-200 transition-colors duration-200 dark:bg-red-900 dark:text-red-200 dark:hover:bg-red-800" title="Delete Course">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        @empty
                        <tr>
                            <td class="px-6 py-10 text-center text-gray-500 dark:text-gray-400" colspan="4">
                                <div class="flex flex-col items-center justify-center">
                                    ...
                                    <p class="text-sm mt-1">Try a different search or add a new course</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
