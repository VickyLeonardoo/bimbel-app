<x-app-layout>
    <div class="container mx-auto px-4 sm:px-8 py-12">
        ...
        <div class="mx-auto bg-white shadow-xl rounded-lg p-8">
            ...
            <form action="{{ route('discount.store') }}" method="POST" class="space-y-6">
                @csrf
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <x-text-input id="name"
                            ...
                            type="text" name="name" :value="old('name')" placeholder="Enter discount name" required
                    ...
                    <div>
                        ...
                        <x-text-input id="code"
                            class="block mt-1 w-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            type="text" name="code" :value="old('code')" placeholder="Enter discount code. Discount code must only contain letters and numbers, and no spaces are allowed." required
                    ...
                    <div>
                        ...
                        <x-text-input id="total"
                            class="block mt-1 w-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            type="text" name="total" :value="old('total')" placeholder="Enter discount total" required
                    ...
                    <div>
                        ...
                        <x-text-input id="date_valid"
                            class="block mt-1 w-full focus:outline-none focus:ring-2 focus:ring-indigo-500"
                            type="date" name="date_valid" :value="old('date_valid')" placeholder="Enter discount date_valid" required
